---
title: "Intro to Bits of Tidyverse"
...
This lesson will introduce data manipulation with the tidyverse, including: tidy data (long vs. wide form objects), how to transform data objects using dplyr commands, object filtering, summarizing and aggregating data. 
...
```{r}
## NOTE that tidyverse is already installed
#install.packages("tidyverse")
```

Before going further, we need to set up our working environment. We will set our working directory and load the **tidyverse** package. We will also load some datasets for us to work with.
...
download.file("https://raw.githubusercontent.com/harvardinformatics/micro-course/nanocourse_2019/r/data/bird_immune_gene_res_simple.csv", "bird_immune_gene_res_simple.csv")
...
```{r}
bus<-read_delim(file="data/mbta_bus.tsv", delim="\t")
```
